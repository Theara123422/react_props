   ...
   return (
      <div className="navbar-container d-flex justify-content-between align-items-center">
         ...
         <ul className="menu mt-3 d-flex list-unstyled">
            ...
            <li>
               <Link className="text-decoration-none navbar-txt" to="/about">
                  About
               </Link>
            </li>
            <li>
               <Link className="text-decoration-none navbar-txt" to="/contact">
                  Contact
               </Link>
            </li>
            <li>
               <Link className="text-decoration-none navbar-txt" to="/dashboard">
                  Dashboard
               </Link>
            </li>
         </ul>
